...
```bash
$ ssh-keygen -t ed25519 -C "alumno@abacom"  
Generating public/private ed25519 key pair.
Enter file in which to save the key (/home/alumno/.ssh/id_ed25519):
Enter passphrase (empty for no passphrase):
Enter same passphrase again:

$ ssh-copy-id -i ~/.ssh/id_ed25519.pub alumno@192.168.56.10  
...
$ cat ~/.ssh/id_ed25519.pub | ssh alumno@192.168.56.10 'mkdir -p ~/.ssh && cat >> ~/.ssh/authorized_keys'  
...
PS> type $env:USERPROFILE\.ssh\id_ed25519.pub | ssh alumno@192.168.56.10 "mkdir -p ~/.ssh && cat >> ~/.ssh/authorized_keys"  
...
**Cómo prevenirlo:**
4. Mantén una sesión SSH abierta mientras pruebas.
5. Valida configuración antes de reiniciar el servicio.
6. Aplica cambios de a uno y verifica.
:::
