---
title: "Retos GNU/Linux (Bandit)"
subtitle: "Introducción, Objetivos y Nivel 0→1"
---
...
**Como prevenirlo:**
3. Aplica esto solo en tu VM de laboratorio.
4. Mantiene una sesion abierta mientras pruebas.
5. Si no funciona, cambia el adaptador a modo **Bridged**.
:::
...
**Como prevenirlo:**
4. Escribe tus notas en tu maquina local.
5. En documentacion publica, usa placeholders como `**PASSWORD_NIVEL_1**`.
:::
...
**Como prevenirlo:**
2. Verifica la huella publicada por el proveedor/infra.
3. Si cambia inesperadamente, detente y valida con el administrador.
:::
...
**Como prevenirlo:**
4. Guarda el password de cada nivel en un archivo local.
5. En tu documentacion, usa placeholders como `**PASSWORD_NIVEL_2**`.
:::
