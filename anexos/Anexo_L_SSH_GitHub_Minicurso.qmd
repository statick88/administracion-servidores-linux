...
1. GitHub tiene tu clave pública guardada
2. Tu máquina prueba que tiene la clave privada correspondiente
3. GitHub descifra el mensaje de prueba (solo posible con tu clave pública)
