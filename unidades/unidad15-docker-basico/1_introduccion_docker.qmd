...
![](./images/docker_image.png){fig-align="center"}
...
![](./images/docker_container.png){fig-align="center"}
...
```bash
$ docker run -d -p 8080:80 -v mi_volumen:/usr/share/nginx/html nginx  
...
$ docker run -d --network mi_red --name app node  
...
```bash
$ docker volume create mi_web  
$ docker run -d -p 8080:80 -v mi_web:/usr/share/nginx/html nginx  
