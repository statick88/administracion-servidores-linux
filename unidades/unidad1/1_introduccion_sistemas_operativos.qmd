...
$ uptime  # <1>
load average: 12.5, 11.2, 10.1  ← Si es > núcleos CPU, está sobrecargado  # <2>

# Verificar swap (disco usado como memoria)
$ swapon -s  # <3>
Filename  Size  Used Priority
/dev/sda1 4000000 3900000 -1  ← Si Used es alto, es el problema  # <4>
```
