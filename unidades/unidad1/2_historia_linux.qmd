...
PS> [System.Environment]::OSVersion  # <1>
Platform ServicePack Version         VersionString
-------- ----------- -------         -------
Win32NT             10.0.22621.3737  Microsoft Windows NT 10.0.22621.3737

# Versión más legible
PS> (Get-Item "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion").GetValue('ProductName')  # <2>
Windows 11 Professional

# Información del kernel
PS> Get-ComputerInfo -Property OsVersion, KernelVersion  # <3>
```
...
PS> Get-Item "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion"  # <1>

ValueName      Type   Value
---------      ----   -----
CurrentBuild   String 22621  # <2>
ReleaseId      String 23H2   # <3>
...
PS> [System.Environment]::OSVersion.VersionString  # <1>
Microsoft Windows NT 10.0.22621.3737

# Verificar que sea Windows 11 Pro/Enterprise
PS> (Get-ComputerInfo -Property WindowsInstallationType).WindowsInstallationType  # <2>
Client

# Versión de PowerShell para scripts
PS> $PSVersionTable.PSVersion  # <3>
...
$ mkdir -p ~/lab-historia-linux  # <1>
$ cd ~/lab-historia-linux  # <2>

# Recopilar información del kernel
$ uname -a > kernel-info.txt  # <3>
$ cat /proc/version >> kernel-info.txt  # <4>
$ cat /etc/os-release >> kernel-info.txt  # <5>

# Ver resultado
$ cat kernel-info.txt  # <6>
```
...
$ cd /tmp  # <1>
$ git clone --depth 1 https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git  # <2>
$ cd linux  # <3>

# Ver primeros commits de 1991
$ git log --reverse --oneline --since="1991-01-01" --until="1991-12-31" | head -10  # <4>

# Ver commits más recientes
$ git log --oneline -n 10  # <5>
```
...
$ cat ~/lab-historia-linux/analisis-versiones.txt  # <2>
```
...
$ cat ~/lab-historia-linux/informe-final.txt  # <2>
```
