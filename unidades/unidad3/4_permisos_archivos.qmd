...
**Cada archivo tiene 3 conjuntos de permisos: Owner, Group, Others. Cada uno puede tener r(4), w(2), o x(1). Los 3 números que más usarás: 755 (scripts), 644 (documentos), 700 (privados).**
...
```
1. Mucho más complejo en PowerShell

2. WSL es más práctico
...
2. Crea un archivo y establece permisos `644`

3. Crea un script y hazlo ejecutable con `chmod +x`

4. Crea un directorio y establece `755`

5. Usa notación simbólica para remover escritura (`g-w`)

6. Ver permisos con `ls -l` e interpreta cada columna

7. Cambia grupo de un archivo con `chgrp`
