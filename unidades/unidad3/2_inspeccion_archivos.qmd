...
PS> Get-Content archivo-grande.txt -ReadCount 0 | Out-Host -Paging  # <2>
# <1>
```
...
#### Linux
```bash
$ tail -f /var/log/apache2/access.log  # <1>
...
PS> Get-Content archivo.txt -Wait -Tail 10  # <1>
