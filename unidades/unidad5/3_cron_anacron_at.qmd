...
**Como prevenirlo:**
4. Usa rutas absolutas a binarios y scripts.
5. Redirige stdout/stderr a un log (`>> ... 2>&1`).
6. Prueba el comando manualmente antes de programarlo.
:::
...
Cuando aplicar:
2. Loguea ejecucion y errores.
3. Agrega validaciones (por ejemplo: chequear espacio antes del backup).
4. Documenta el job (que hace, donde deja logs, como desactivarlo).
:::
