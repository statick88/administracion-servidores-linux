...
**Como prevenirlo:**
5. Usa `SIGTERM` primero y espera unos segundos.
6. Verifica con `ps -p **PID**`.
7. Usa `SIGKILL` solo si el proceso no responde.
:::
...
#### Windows
```powershell
PS> Get-Process -Name notepad | Select-Object Name,Id  

Name    Id
----    --
notepad 7332

PS> Stop-Process -Id 7332  
...
Cuando aplicar:
3. Snapshot: `ps aux --sort=-%cpu` y `ps aux --sort=-%mem`.
4. Observacion: `top` por 30-60 segundos.
5. Accion: `kill -TERM` y verificacion.
:::
