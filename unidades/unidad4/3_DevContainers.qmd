...
1. **print()** imprime "Hola, Mundo!" por consola. Este es el código de prueba que demuestra que el DevContainer está configurado correctamente y ejecuta Python en un entorno aislado.
