...
Como prevenirlo:
3. Define retencion (por dias o tamano) y documentala.
4. Valida con el equipo (seguridad/operaciones) antes de acortar retencion.
5. Si borras, deja evidencia (ticket/cambio).
:::
