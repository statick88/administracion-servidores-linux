...
Opciones de hipervisor:
- Intel Mac: VirtualBox (gratis) o Parallels (pagado)
- Apple Silicon: UTM (gratis) o Parallels (pagado)
...
⚠️ **ADVERTENCIA**: **dd** sin validación puede **destruir tu disco principal**. Verifica 3 veces que **/dev/sdX** es el USB correcto.
...
⚠️ **ADVERTENCIA**: Manejo incorrecto de particiones = **pérdida total de datos**. Practica primero en máquina virtual.
