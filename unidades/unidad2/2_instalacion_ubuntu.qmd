...
1. **brew install multipass** instala el gestor de máquinas virtuales de Canonical en macOS
2. **multipass transfer** copia archivos del host a la VM (y viceversa) sin configurar SSH manualmente
...
1. **Get-Disk** muestra todos los discos físicos — verifica el número de disco y espacio libre antes de modificar
2. **Resize-Partition** reduce la partición C: liberando 100 GB para Ubuntu
