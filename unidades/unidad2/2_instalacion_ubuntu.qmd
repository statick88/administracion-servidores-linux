---
title: "Instalación de Ubuntu 22.04 LTS Paso a Paso"
...
# Instalación de Ubuntu 22.04 LTS Paso a Paso

## Introducción

Esta lección te guiará a través del proceso completo de instalación de Ubuntu 22.04 LTS. El instalador de Ubuntu es amigable e intuitivo, pero entender cada paso te ayuda a tomar decisiones informadas sobre particiones, usuarios y configuración del sistema [@ubuntu_install_guide].
...
Asegúrate de tener:
✓ USB booteable con Ubuntu 22.04 LTS (de lección anterior)
...
**ADVERTENCIA: "Erase disk" borra TODOS los datos existentes**.

Selecciona **"Erase disk and install Ubuntu"** si:
- Es nueva máquina
...
Versión 5.15+ es correcta para Ubuntu 22.04 LTS.
...
**Escenario**: Abacom necesita 5 servidores Ubuntu 22.04 LTS
...
PS> Invoke-WebRequest -Uri "https://releases.ubuntu.com/22.04/ubuntu-22.04.3-live-server-amd64.iso" `
    -OutFile "C:\Users\usuario\Downloads\ubuntu-22.04.3.iso"
...
3. Configura media de arranque:
   ...
   └─ Selecciona ISO de Ubuntu 22.04.x
...
4. Monta el ISO:
   ...
   └─ Selecciona ubuntu-22.04.x-desktop-amd64.iso
...
- ✅ Ubuntu 22.04 LTS completamente instalado
...
## ¿Cuál es el sistema de archivos predeterminado recomendado en Ubuntu 22.04?
